export type Folder={id:string;region:string;date:string;lot:string;unit?:string;group:number;time:string;name:string;phones:string[];address:string;notes:string;warning?:boolean;count:number;bytes:number};
