...
const worker=await createWorker(['kor','eng'],1,{langPath:new URL('../public/ocr/',import.meta.url).pathname,cacheMethod:'none',corePath:new URL('../public/ocr/tesseract-core-lstm.wasm.js',import.meta.url).pathname},{tessedit_load_sublangs:''});
