  ...
  return <div className="app-shell">
    ...
    <div className="workspace-layout">
      ...
      <main className="main-workspace">
        ...
        {!active&&!selected&&<FolderSearch folders={scoped} query={searchQuery} onQuery={setSearchQuery} view={view} onOpen={(f,path)=>location(f.region,view==='date'?f.date:null,f.id,path)}/>}
